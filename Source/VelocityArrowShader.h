...
public:
    ...
    void Execute() {
        ...
        vec3 color = { 1,0,0 };
        glProgramUniform3f(
            GetShader(arrowColor_shaderType)->_glidShaderProgram,
            arrowColor_loc,
            color.x,
            color.y,
            color.z
        ...
        glm::mat4 viewProjMat = app->_viewProjMat;
        glProgramUniformMatrix4fv(
            GetShader(vpMat_shaderType)->_glidShaderProgram,
            vpMat_loc,
            1,
            GL_FALSE,
            glm::value_ptr(viewProjMat)
        );
